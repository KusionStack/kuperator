...
func InitDefaultRuleStage(ruleDef *appsv1alpha1.RuleSetRuleDefinition, stage string) {
	ruleStage[GetRuleType(ruleDef)] = stage
}

func GetRuleStage(ruleDef *appsv1alpha1.RuleSetRuleDefinition) string {
...
func GetRuleType(ruleDef *appsv1alpha1.RuleSetRuleDefinition) string {
