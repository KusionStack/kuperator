...
type Ruler interface {
	Filter(ruleSet *appsv1alpha1.RuleSet, targets map[string]*corev1.Pod, subjects sets.String) *FilterResult
}
...
func GetRuler(rule *appsv1alpha1.RuleSetRule, client client.Client) Ruler {
