...
func PodHasRuleSetStage(c client.Client, pod *corev1.Pod, stage string, isDefaultStage bool) (bool, error) {
	rsList := &appsv1alpha1.RuleSetList{}
	if err := c.List(context.TODO(), rsList, &client.ListOptions{FieldSelector: fields.OneTermEqualSelector(inject.FieldIndexRuleSet, pod.Name)}); err != nil {
		return false, err
	}
